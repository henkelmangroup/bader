...
- [NaCl](https://theory.cm.utexas.edu/henkelman/code/bader/download/NaCl.tar.gz) crystal (vasp chgcar)
- [NaCl](https://theory.cm.utexas.edu/henkelman/code/bader/download/NaCl_wcore.tar.gz) crystal including core charges
  (vasp chgcar)
- [C<sub>2</sub>H<sub>4</sub>](https://theory.cm.utexas.edu/henkelman/code/bader/download/C2H4a.tar.gz) molecule, orientation 1 (vasp
  chgcar)
- [C<sub>2</sub>H<sub>4</sub>](https://theory.cm.utexas.edu/henkelman/code/bader/download/C2H4b.tar.gz) molecule, orientation 2 (vasp
  chgcar)
- [H<sub>2</sub>O](https://theory.cm.utexas.edu/henkelman/code/bader/download/H2O.tar.gz) molecule (gaussian cube)
