...
PROGRAM Charge
  ...
  IF (n == 1 .OR. n == 2) THEN
    ...
    WRITE(*,'(4X,A)') '1 ... WRITE ALL BADER VOLUMES TO FILES'
    WRITE(*,'(4X,A)') '2 ... WRITE BADER VOLUME(S) FOR EACH ATOM TO FILE'
    WRITE(*,'(4X,A)') '3 ... WRITE SPECIFIED BADER VOLUMES TO FILE'   
    WRITE(*,'(4X,A)') '4 ... DO NOT WRITE OUT ANY BADER VOLUMES'      
